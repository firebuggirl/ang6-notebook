...
//fixedSizeData = Array(10000).fill(30);
  ...
  statesCount = Array.from(this.states).map((_, i) => `State #${i}`);
  ...
  // saveNote() {
  //   this.notebookService.insertNote(this.note)
  //     .subscribe((res: Note) => { this.router.navigate(['/notebook']); }, (err) => console.log(err));
  // }
